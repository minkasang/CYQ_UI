...
const PRESETS = [
  ...
  { name: '象牙', rgb: '255,250,240' },
  { name: '浅金', rgb: '255,235,190' },
  { name: '香槟', rgb: '255,228,196' },
  { name: '桃色', rgb: '255,218,185' },
  { name: '冰蓝', rgb: '220,240,255' },
  { name: '天蓝', rgb: '210,235,255' },
  { name: '浅绿', rgb: '220,255,235' },
  { name: '薄荷', rgb: '200,250,225' },
  { name: '浅紫', rgb: '240,225,255' },
  { name: '薰衣草', rgb: '230,215,250' },
  { name: '浅粉', rgb: '255,225,235' },
  { name: '玫瑰', rgb: '255,215,225' },
  { name: '月光', rgb: '235,240,255' },
  { name: '晨曦', rgb: '255,245,230' },
  { name: '薄暮', rgb: '245,235,220' },
  { name: '霜白', rgb: '240,245,250' },
  { name: '银灰', rgb: '220,220,225' },
]
